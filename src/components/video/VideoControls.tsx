...
const VideoControls: React.FC<VideoControlsProps> = ({
  ...
  return (
    <div 
      ref={controlsRef}
      className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4 flex items-center space-x-4"
    >
      <button 
        onClick={onPlayPause}
      ...
      <button 
        onClick={() => onFullscreen(controlsRef.current?.parentElement || null)}
        className="text-white focus:outline-none"
